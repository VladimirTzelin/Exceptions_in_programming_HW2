...
public class Main {
    public static void main(String[] args){
        //exaple1()         // Произошла ошибка при преобразовании введенного значения в число с плавающей точкой
        //exaple2();        // Catching exception: java.lang.ArithmeticException: / by zero
        //exaple3();        // Массив выходит за пределы своего размера!
        exaple4();          // Введена пустая строка
    }

    public static void exaple1(){
